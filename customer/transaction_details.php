<?php include_once("../administrator/header.php");
    ...
    $accounts = $statement->getTransactionList($number, $id);
?>
                                ...
                                <div class="col-md-12 dt-masonry__item">
                                    <div class="dt-card">
                                        ...
                                        <ol class="mb-0 breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="transaction_details.php?account_number=<?php echo $account_number ?>&&transaction_id=<?php echo $id ?>">View Transactions Details</a></li>
                                ...
                                <div class="dt-module__sidebar">
                                    ...
                                    <div class="dt-module__sidebar-header border-bottom">
                                        <div class="d-none d-md-flex align-items-center">
                                            ...
                                            <span class="h3 mb-0">All Accounts</span>
                                        </div>
                                    ...
                                    <div class="dt-module__sidebar-content ps-custom-scrollbar">
                                        ...
                                        <ul class="dt-module-side-nav">
                                            ...
                                            <li class="dt-module-side-nav__header">
                                                <span class="dt-module-side-nav__text"><?php echo $_SESSION['full_name'] ?></span>
                                            </li>
                                            <!-- /menu header -->
